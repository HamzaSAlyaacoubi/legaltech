  ...
  return (
    <div className="bg-surface text-on-surface min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-8 py-8">
          ...
          <section className="mb-16 text-center max-w-3xl mx-auto">
            ...
            <div className="relative group animate-fadeInUp animation-delay-200">
              <div className="absolute -inset-1 bg-gradient-to-r from-[#99462a]/10 to-primary-container/10 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000"></div>
              <div className="relative flex items-center bg-surface-container-lowest shadow-[0px_12px_32px_rgba(29,28,22,0.06)] rounded-2xl p-2 transition-all border border-outline-variant/10 focus-within:border-[#99462a]/30 focus-within:shadow-[0px_12px_32px_rgba(153,70,42,0.08)]">
                <span className="material-symbols-outlined ml-4 text-[#99462a]"><Sparkles className="text-[#99462a]" /></span>
                ...
                <div className="flex items-center gap-2 mr-1">
                  <button className="p-3 rounded-xl text-[#99462a] hover:bg-[#99462a]/5 transition-colors flex items-center justify-center" title="Voice input">
                    <span className="material-symbols-outlined"><Mic /></span>
                  </button>
                  <button className="bg-[#99462a] text-white p-3 rounded-xl font-semibold flex items-center justify-center hover:bg-[#7a2f15] transition-colors" title="Send">
          ...
          <section className="mb-12">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="group p-8 rounded-xl bg-surface-container-lowest border border-outline-variant/5 hover:border-[#99462a]/20 hover:shadow-lg transition-all duration-300 cursor-pointer animate-scaleIn animation-delay-300 hover:scale-105">
                <div className="w-12 h-12 rounded-lg bg-[#99462a]/5 flex items-center justify-center text-[#99462a] mb-6 group-hover:scale-110 transition-transform">
            ...
            <div className="bg-surface-container-lowest rounded-xl p-8 shadow-sm animate-fadeInUp animation-delay-400">
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-bold flex items-center gap-3">
                  <span className="material-symbols-outlined text-[#99462a]"><Folder /></span>
                  Recent Folders
                </h2>
                <button className="text-[#99462a] text-sm font-semibold hover:underline">View All</button>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* TechCorp Card */}
                <div className="group relative bg-surface p-5 rounded-2xl border border-outline-variant/5 hover:border-[#99462a]/20 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer hover:-translate-y-1">
                  <div className="flex flex-col gap-4">
                    <div className="flex items-start justify-between">
                      <div className="w-12 h-12 rounded-xl bg-[#99462a]/5 flex items-center justify-center text-[#99462a] group-hover:bg-[#99462a] group-hover:text-white transition-colors duration-300">
                        <span className="material-symbols-outlined text-2xl"><Folder /></span>
                      </div>
                      <span className="material-symbols-outlined text-[#615e59]/30 group-hover:text-[#99462a] transition-colors"><MoreVertical /></span>
                    </div>
                    <div>
                      <h4 className="text-sm font-bold text-on-surface mb-1 group-hover:text-[#99462a] transition-colors">TechCorp Q3 Audits</h4>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            ...
            <div className="bg-surface-container-lowest rounded-xl p-8 shadow-sm h-full animate-fadeInUp animation-delay-500">
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-bold flex items-center gap-3">
                  <span className="material-symbols-outlined text-[#99462a]"><Check /></span>
                  Tasks
                </h2>
                <button className="text-[#99462a] text-sm font-semibold hover:underline">View All</button>
              </div>
              <div className="space-y-4">
                <div className="flex items-center p-4 rounded-lg bg-surface hover:bg-surface-container-low transition-colors group">
                  <button className="w-6 h-6 rounded-md border-2 border-outline-variant flex items-center justify-center mr-4 group-hover:border-[#99462a] transition-colors">
                    <span className="material-symbols-outlined text-[0px] group-hover:text-[16px] text-[#99462a]"><Check /></span>
                  </button>
                ...
                <div className="flex items-center p-4 rounded-lg bg-surface hover:bg-surface-container-low transition-colors group border-l-4 border-[#99462a]">
                  <button className="w-6 h-6 rounded-md border-2 border-outline-variant flex items-center justify-center mr-4 group-hover:border-[#99462a] transition-colors">
                    <span className="material-symbols-outlined text-[0px] group-hover:text-[16px] text-[#99462a]"><Check /></span>
                  </button>
                  <div className="flex-1">
            ...
            <div className="bg-surface-container-lowest rounded-xl p-8 shadow-sm h-full animate-fadeInUp animation-delay-600">
              <div className="flex items-center justify-between mb-8">
                ...
                <button className="text-[#99462a] text-sm font-semibold hover:underline">History</button>
              </div>
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-3 rounded-xl border border-outline-variant/10 hover:bg-surface transition-colors group cursor-pointer">
                  <div className="w-10 h-10 rounded-full bg-[#99462a]/5 flex items-center justify-center text-[#99462a]">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      <div className="h-1.5 w-16 bg-surface-container-high rounded-full overflow-hidden">
                        <div className="h-full bg-[#99462a] w-3/4"></div>
                      </div>
                      <span className="text-[10px] text-[#615e59] font-medium uppercase tracking-tighter">75% Complete</span>
                    </div>
                  </div>
                  <span className="material-symbols-outlined text-[#615e59]/40 text-lg group-hover:text-[#99462a] transition-colors"><ChevronRight /></span>
                </div>
                <div className="flex items-center gap-4 p-3 rounded-xl border border-outline-variant/10 hover:bg-surface transition-colors group cursor-pointer">
      ...
      <div className="fixed bottom-8 right-8 z-50 animate-scaleIn animation-delay-700">
        <button className="w-14 h-14 bg-[#99462a] text-white rounded-full shadow-2xl flex items-center justify-center hover:scale-110 active:scale-95 transition-all group overflow-hidden animate-pulse-subtle">
